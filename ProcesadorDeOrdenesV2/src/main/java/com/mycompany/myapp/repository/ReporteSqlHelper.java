...
public class ReporteSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("operacion_exitosa", table, columnPrefix + "_operacion_exitosa"));
        columns.add(Column.aliased("operacion_observaciones", table, columnPrefix + "_operacion_observaciones"));
